...
```
Create a {ASPECT_RATIO} image in the "Tri Color Hardcut Portrait Poster" style.
...
SUBJECT_ACTION: staring forward while holding one hand near the ch...
PRODUCT_OR_PROP: small over-ear headphones reduced to black and cor...
```
...
![vigo_tri_color_hardcut_portrait_poster.md](https://malongan.github.io/images/vigo_previews/tri-color-hardcut-portrait-poster.jpg)
