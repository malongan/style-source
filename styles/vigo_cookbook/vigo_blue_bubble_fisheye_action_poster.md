...
```
Create an image in blue-bubble-fisheye-action-poster-style.
...
SUBJECT_ACTION: lunging toward a low fisheye camera while lowering...
PRODUCT_OR_PROP: translucent green plant delivery crate, circled in...
```
...
![blue-bubble-fisheye-action-poster-style](https://malongan.github.io/images/vigo_previews/blue-bubble-fisheye-action-poster.jpg)
