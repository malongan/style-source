...
```
Create an image in sunburst-fisheye-bubble-type-poster-style.
...
```
SUBJECT_IDENTITY: adult East Asian woman with a short copper bob hai...
SUBJECT: a roadside fashion traveler...
SUBJECT_ACTION: leaning toward the fisheye camera and looking abov...
```
...
![vigo_sunburst_fisheye_bubble_type_poster.md](https://malongan.github.io/images/vigo_previews/sunburst-fisheye-bubble-type-poster.jpg)
