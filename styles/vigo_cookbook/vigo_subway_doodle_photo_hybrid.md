...
- clean vector-only illustration
- polished advertising layout
- empty vehicle
- luxury lighting
- perfect studio composition
...
SUBJECT_ACTION: laughing as doodled cartoon heads replace their fa...
PRODUCT_OR_PROP: large hot-pink cartoon thumbs-up entering from the...
```
...
![vigo_subway_doodle_photo_hybrid.md](https://malongan.github.io/images/vigo_previews/subway-doodle-photo-hybrid.jpg)
