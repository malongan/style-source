...
```
Create a {ASPECT_RATIO} image in analog-sticker-diary-portrait-poster-style.
...
```
SUBJECT: a quiet young illustrator in side profile with sho...
SUBJECT_ACTION: listening to music while staring past a rainy cafe...
PRODUCT_OR_PROP: large cream over-ear headphones with tiny sticker ...
```
...
![analog-sticker-diary-portrait-poster-style](https://malongan.github.io/images/vigo_previews/analog-sticker-diary-portrait-poster.jpg)
