...
```
Create a {ASPECT_RATIO} image in the "Rough Animation Pet Sketch Storyboard" style.
...
```
SUBJECT: a narrow-eyed gray cat and a cream dog caught in t...
SUBJECT_ACTION: the cat silently interrogates the dog while the do...
PRODUCT_OR_PROP: orange cookie jar tipped open with round biscuits ...
```
...
![rough-animation-pet-sketch-storyboard-style](https://malongan.github.io/images/vigo_previews/rough-animation-pet-sketch-storyboard.jpg)
